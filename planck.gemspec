...
require_relative "lib/planck/version"

Gem::Specification.new do |spec|
  spec.name = "planck"
  spec.version = Planck::VERSION
  spec.authors = ["Matheus Richard"]
  spec.email = ["matheusrichardt@gmail.com"]

  spec.summary = "Atomic file writes for Ruby"
  ...
  TEXT
  spec.homepage = "https://github.com/thoughtbot/planck"
  spec.license = "MIT"
